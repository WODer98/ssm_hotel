...
public class Orders {
    ...
    //房间对象
    private com.wod.entity.Room room;
    //房型对象
    private com.wod.entity.RoomType roomType;

    public com.wod.entity.Room getRoom() {
        return room;
    }

    public void setRoom(com.wod.entity.Room room) {
        this.room = room;
    }

    public com.wod.entity.RoomType getRoomType() {
        return roomType;
    }

    public void setRoomType(com.wod.entity.RoomType roomType) {
